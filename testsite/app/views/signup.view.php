...
<meta name="theme-color" content="#712cf9">
  ...
  <?php endif;?>
    ...
    <h1 style="text-align: center;"><img src= "<?=ROOT?>/assets/images/logo.png"></h1>
    <h1 class="h3 mb-3 fw-normal" style="text-align: center;">Signup</h1>
    ...
    <div class="form-check d-flex justify-content-center my-3">
      <label class="form-check-label">
        <input class="form-check-input me-2" name="terms" type="checkbox" value="1">
            Accept Terms
      </label>
    </div>
